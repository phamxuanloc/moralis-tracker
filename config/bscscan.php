...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    'moralis_base_url' => env('MORALIS_BASE_URL', 'https://deep-index.moralis.io/api/v2.2'),
    ...
    */
    'moralis_chain' => env('MORALIS_CHAIN', 'bsc'),

    /*
    |--------------------------------------------------------------------------
    | Addresses to Track
    |--------------------------------------------------------------------------
    | List of BSC wallet addresses to monitor. Can also be managed via the
    | tracked_addresses database table.
    */
    'addresses' => array_filter(explode(',', env('BSCSCAN_ADDRESSES', ''))),
    ...
    | internal - Internal contract transactions
    ...
    */
    ...
    'max_retries' => env('BSCSCAN_MAX_RETRIES', 3),
    ...
    */
    ...
    | Logging
    |--------------------------------------------------------------------------
    | Log channel to use. Defaults to the default Laravel log channel.
    */
    'log_channel' => env('BSCSCAN_LOG_CHANNEL', env('LOG_CHANNEL', 'stack')),
